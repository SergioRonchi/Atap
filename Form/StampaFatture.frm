...
Begin VB.Form StampaFatture 
   ...
   Begin VB.Frame FrmRicercaTribunali 
      ...
      Begin TDBDate6Ctl.TDBDate txtDataDa 
         ...
         _ExtentX        =   3836
         _ExtentY        =   450
         Calendar        =   "StampaFatture.frx":0000
         Caption         =   "StampaFatture.frx":0118
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "StampaFatture.frx":0178
         Keys            =   "StampaFatture.frx":0196
         Spin            =   "StampaFatture.frx":01F4
         AlignHorizontal =   0
         AlignVertical   =   0
         Appearance      =   1
         BackColor       =   -2147483643
      ...
      Begin TDBDate6Ctl.TDBDate txtDataA 
         ...
         _ExtentX        =   3836
         _ExtentY        =   450
         Calendar        =   "StampaFatture.frx":021C
         Caption         =   "StampaFatture.frx":0334
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "StampaFatture.frx":0394
         Keys            =   "StampaFatture.frx":03B2
         Spin            =   "StampaFatture.frx":0410
         AlignHorizontal =   0
         AlignVertical   =   0
         Appearance      =   1
         BackColor       =   -2147483643
   ...
   End
End
Attribute VB_Name = "StampaFatture"
...
Private Sub CmdOK_Click()
    ...
    Call Stampa.gestioneReport("", qrySQL, 0, IIf(OptModSt(0).value, crptToWindow, crptToPrinter), "Fattura.rpt", 2)
End Sub
...
Private Sub CmdRicerca_Click()
    ...
    qry = "SELECT CODAVV,DataFatturaNormale As Data,Nome as Avvocato,NumOrdinamento,NumeroFattura,datafattura FROM StoricoFatture "
...
Private Sub getDataFattura()
    txtDataDa.value = GetADOValue("Date_EstrattiConto", "DATA_FATTURA", "1=1", g_Settings.DBConnection)
