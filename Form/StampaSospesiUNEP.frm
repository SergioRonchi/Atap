...
Begin VB.Form StampaSospesiUNEP 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Stampa Inevasi UNEP"
   ClientHeight    =   6855
   ClientLeft      =   45
   ClientTop       =   210
   ClientWidth     =   5505
   ...
   Begin VB.PictureBox PictureUNEP 
      ...
      Height          =   495
      Left            =   120
      Picture         =   "StampaSospesiUNEP.frx":0000
      ScaleHeight     =   465
      ScaleWidth      =   465
      TabIndex        =   25
      Top             =   6120
   ...
   Begin VB.Frame FrmStampa 
      ...
      Begin VB.Frame FrmTipoStampa 
         ...
         Begin TrueOleDBList80.TDBCombo cmbTribunale 
            ...
            AddItemSeparator=   ";"
            _PropDict       =   $"StampaSospesiUNEP.frx":0442
         ...
         Begin TrueOleDBList80.TDBCombo cmbAttivit‡ 
            ...
            RowSubDividerColor=   14215660
            AddItemSeparator=   ";"
            _PropDict       =   $"StampaSospesiUNEP.frx":04C9
            _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
            _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
            _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
            _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
      ...
      Begin VB.Frame frm 
         ...
         Begin TDBDate6Ctl.TDBDate TxtRicDataIn 
            ...
            _ExtentX        =   2990
            _ExtentY        =   450
            Calendar        =   "StampaSospesiUNEP.frx":0550
            Caption         =   "StampaSospesiUNEP.frx":0668
            ...
            EndProperty
            DropDown        =   "StampaSospesiUNEP.frx":06D4
            Keys            =   "StampaSospesiUNEP.frx":06F2
            Spin            =   "StampaSospesiUNEP.frx":0750
            AlignHorizontal =   0
            AlignVertical   =   0
            Appearance      =   1
         ...
         Begin TDBDate6Ctl.TDBDate TxtRicDataFin 
            ...
            _ExtentX        =   2990
            _ExtentY        =   450
            Calendar        =   "StampaSospesiUNEP.frx":0778
            Caption         =   "StampaSospesiUNEP.frx":0890
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
               ...
               Strikethrough   =   0   'False
            EndProperty
            DropDown        =   "StampaSospesiUNEP.frx":08FC
            Keys            =   "StampaSospesiUNEP.frx":091A
            Spin            =   "StampaSospesiUNEP.frx":0978
            AlignHorizontal =   0
            AlignVertical   =   0
            Appearance      =   1
            BackColor       =   -2147483643
   ...
   End
End
Attribute VB_Name = "StampaSospesiUNEP"
...
Dim codAttivit‡ As String
    ...
    If IsPrtTableLocked("PrtSospesiUNEP") Then
...
End If
    Riempi_PRT_Sospesi TxtRicDataIn.Text, TxtRicDataFin.Text, TxtCodiceAvvocato.Text, codTribunale, codAttivit‡, True, False, IIf(optMese(0).value, 1, 2)
    ...
    If Not GetADORecordset("PrtSospesiUNEP", "*", "1=1", g_Settings.DBConnection) Is Nothing Then
        ...
        If OptTipoStampa(0).value = True Then
            NomeFile = "SospesiNewUNEP.rpt"
        End If
        If OptTipoStampa(1).value = True Then
            NomeFile = "SospesiAttivit‡NewUNEP.rpt"
        End If
        If OptTipoStampa(2).value = True Then
            NomeFile = "SospesiAttTribNewUNEP.rpt"
        End If
        Call Stampa.gestioneReport("PrtSospesiUNEP", "", 0, IIf(OptModSt(0).value, crptToWindow, crptToPrinter), NomeFile, 1)
...
Private Sub Form_Load()
   ...
   'TxtRicDataIn = getPrecChiusura()
    ...
    PopolaTDBCombo cmbAttivit‡, "Attivit‡", "Descrizione", "CodiceAttivita", , , , "SELECT Descrizione,CodiceAttivita FROM Attivit‡ WHERE CodiceAttivita IN ('N','S')"
